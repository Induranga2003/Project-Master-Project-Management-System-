...
export const authAPI = {
  ...
  sendContact: (data) => api.post('/auth/contact', data),
...
export const chatAPI = {
  ...
  addReaction: (projectId, messageId, emoji) => api.post(`/chat/project/${projectId}/messages/${messageId}/reactions`, { emoji }),
  removeReaction: (projectId, messageId, emoji) => api.delete(`/chat/project/${projectId}/messages/${messageId}/reactions?emoji=${encodeURIComponent(emoji)}`),
};
